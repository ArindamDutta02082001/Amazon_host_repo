...
const order_model = require("./DatabaseFiles/Admin_Order_SchemaandModel");
const path = require("path");

ser.use(express.static(path.join(__dirname, "./frontend/build")));
...
if (process.env.NODE_ENV == "production") {
  ser.use(express.static("amazon/build"));
}
// heroku end
